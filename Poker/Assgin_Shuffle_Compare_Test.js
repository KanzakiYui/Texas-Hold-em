    ...
    if(HandRankings[leftHandRank.result]>HandRankings[rightHandRank.result])
        ...
        */
        if(leftHandRank.result=="Straight Flush"){
            ...
            var result = arrayOfRanksComparison(leftRanks, rightRanks);
            if(result == 1)
            ...
            if(leftRank>rightRank)
                ...
                var result = arrayOfRanksComparison(leftKickers, rightKickers);
                if(result == 1)
...
function GetHandRank(hand){
    ...
    var isRankSequence = IsRankInSequence(ranks);
...
*/
function IsRankInSequence(arrayVar){
...
*/
function arrayOfRanksComparison(array1, array2){
...
var leftHand = new Hand();
var rightHand = new Hand();
leftHand.Add(new Card('Club', 2)).Add(new Card('Club', 3)).Add(new Card('Club', 14)).Add(new Card('Club', 5)).Add(new Card('Club', 4));
rightHand.Add(new Card('Heart', 4)).Add(new Card('Heart', 5)).Add(new Card('Heart', 6)).Add(new Card('Heart', 8)).Add(new Card('Heart', 7));
var message = "Left Hand:\n"+leftHand.quickDebugShow()+"\nRight Hand:\n"+rightHand.quickDebugShow()+"\n";
message +="Result:\n"+Compare(leftHand, rightHand);
console.log(message);
